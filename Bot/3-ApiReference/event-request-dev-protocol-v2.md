...
* [Request](#2-request)
  * [协议概览](#21-协议概览)
  * [Event定义](#22-event-定义)
  * [Context定义](#23-context-定义)
  * [Location定义](#24-location-定义)
  * [Lang定义](#25-lang定义)
* [Response](#3-response)
  * [协议概览](#31-协议概览)
...
| parameters  | Map | [Param定义](/Bot/3-ApiReference/skill-dev-protocol.md) | Optional |
...
| results | Result 对象 | [Result](skill-dev-protocol.md#results-array) | Optional |
```
{
...
| params | Map | [Map<string, slu.Value>](skill-dev-protocol.md) | Required |
